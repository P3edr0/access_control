...
abstract class AccFontStyle {
  static TextStyle h0 = GoogleFonts.roboto().copyWith(
    height: Responsive.getFontValue(60),
    color: Colors.black,
  );
  static TextStyle titleLarge = GoogleFonts.roboto().copyWith(
    height: Responsive.getFontValue(54),
    color: Colors.black,
  );

  static TextStyle h1 = GoogleFonts.roboto().copyWith(
    fontSize: Responsive.getFontValue(50),
    color: Colors.black,
  );
  static TextStyle h2 = GoogleFonts.roboto().copyWith(
